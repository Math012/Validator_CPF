...
#CREATE THE CONFIGURATION OF WINDOW
    def Window(self):
...
#CREATE THE ALL ELEMENTS RELATED THE WINDOW
    def WindowElements(self):
        #CREATE LABEL AND ENTRY
        #THIS ENTRY GO GET THE CPF NUMBER THAT THE USER WRITED
        ...
        #ADDING MORE INFORMATION ABOUT THE FORMAT OF THIS PROGRAM, SUCH AS: NUMBERS WITHOUT SIGNAL OR SYMBOLS, 
        #THIS PROGRAM MUST CONTAIN 11 NUMBERS AND FOR THIS PROGRAM TO WORK BETTER IT IS RECOMMENDED THAT YOU CLICK
        #THE "RESET" BUTTON 
        ...
        # THE BUTTON START GOES VERIFY THE NUMBER OF CPF AND RETURN "CPF VALIDO"(CPF validate) or "CPF INVALIDO"(CPF not validate)
        ...
        # THE BUTTON RESET GOES CLEAR THE ALL ENTRYS THIS PROGRAM
    ...
    # THE DEF "Calc" CONTAIN ALL LOGIC AND CALCULE FOR NECESSARY TO VALIDATE CPF NUMBER
    def Calc(self):
        ...
        if self.lista[9] == self.total:
            ...
            if self.lista[10] == self.total2:
                self.entry_result.insert(0,f"CPF VÁLIDO")
            else:
                self.entry_result.insert(0,f"CPF INVÁLIDO")                    
        else:
            self.entry_result.insert(0,f"CPF INVÁLIDO") 
    # THE DEF "Reset" RESET THE ALL ENTRYS
    def Reset(self):
